package algorithms; /******************************************************************************
 *  Compilation:  javac algorithms.StdDraw.java
 *  Execution:    java algorithms.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code algorithms.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code algorithms.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">algorithms.StdDraw.java</a>
 ...
 *           algorithms.StdDraw.setPenRadius(0.05);
 *           algorithms.StdDraw.setPenColor(algorithms.StdDraw.BLUE);
 *           algorithms.StdDraw.point(0.5, 0.5);
 *           algorithms.StdDraw.setPenColor(algorithms.StdDraw.MAGENTA);
 *           algorithms.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code algorithms.StdDraw.line()} and {@code algorithms.StdDraw.point()}
 *  draw lines and points; the methods {@code algorithms.StdDraw.setPenRadius()}
 *  and {@code algorithms.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code algorithms.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   algorithms.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code algorithms.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code algorithms.StdDraw.setPenColor(algorithms.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code algorithms.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code algorithms.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   algorithms.StdDraw.setFont(font);
 *   algorithms.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code algorithms.StdDraw.clear(algorithms.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   algorithms.StdDraw.setScale(-2, +2);
 *   algorithms.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       algorithms.StdDraw.clear();
 *       algorithms.StdDraw.filledCircle(x, y, 0.05);
 *       algorithms.StdDraw.filledCircle(-x, -y, 0.05);
 *       algorithms.StdDraw.show();
 *       algorithms.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code algorithms.StdDraw.BLACK}, {@code algorithms.StdDraw.BLUE}, {@code algorithms.StdDraw.CYAN},
     * {@code algorithms.StdDraw.DARK_GRAY}, {@code algorithms.StdDraw.GRAY}, {@code algorithms.StdDraw.GREEN},
     * {@code algorithms.StdDraw.LIGHT_GRAY}, {@code algorithms.StdDraw.MAGENTA}, {@code algorithms.StdDraw.ORANGE},
     * {@code algorithms.StdDraw.PINK}, {@code algorithms.StdDraw.RED}, {@code algorithms.StdDraw.WHITE}, and
     * {@code algorithms.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithms.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithms.StdDraw)
        try {
            URL url = algorithms.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
